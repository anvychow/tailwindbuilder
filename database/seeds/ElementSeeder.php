    ...
    public function run()
    {
        DB::table('elements')->insert([
            [
                'name' => 'cta1',
                'category' => 'CTAs',
                'thumbnail' => asset('img/previews/ctas/cta1.png'),
            ...
            [
                'name' => 'hero1',
                'category' => 'Heros',
                'thumbnail' => asset('img/previews/heros/hero1.png'),
                'html' => '<div class="relative bg-white overflow-hidden">
            ...
            [
                'name' => 'feature1',
                'category' => 'Features',
                'thumbnail' => asset('img/previews/features/feature1.png'),
